<?php
/**
 * Jeu de données initial (effectif + heures de juillet), miroir de src/utils/seed.js.
 * Chargé par seed_database() lorsque la table employees est vide ou lors d'un reset.
 */
